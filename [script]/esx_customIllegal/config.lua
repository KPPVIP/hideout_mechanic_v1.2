...
Config.Locale            = 'fr'
Config.IsillegalmecanoJobOnly = true

Config.Zones = {

	ls1 = {
		Pos   = { x = 1031.9299, y = -2528.5625, z = 28.32},
	...
	ls2 = {
		Pos   = { x = 1035.5887, y = -2548.7639, z = 28.49},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	ls3 = {
		Pos   = { x = 1032.62, y = -2542.0065, z = 28.32},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	ls4 = {
		Pos   = { x = 1042.7145, y = -2530.7089, z = 28.29},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	ls5 = {
		Pos   = { x = 1040.4213, y = -2514.5583, z = 28.35},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
