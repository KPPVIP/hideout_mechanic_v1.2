...
Config.Zones = {
	...
	illegalmecanoActions = {
		Pos   = { x = 1000.1482, y = -2552.0798, z = 31.85 },
	...
	Garage = {
		Pos   = { x = 1008.6192, y = -2550.78002, z = 27.10 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 204, g = 204, b = 0 },
		Type  = 1
	},
	...
	Craft = {
		Pos   = { x = 1032.7100, y = -2555.5195, z = 27.29 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 204, g = 204, b = 0 },
		Type  = 1
	},
	...
	VehicleSpawnPoint = {
		Pos   = { x = 1043.89, y = -2504.4790, z = 28.35 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = -1
	},

	VehicleDeleter = {
		Pos   = { x = 1046.3621, y = -2492.3337, z = 27.5084 },
	...
	VehicleDelivery = {
		Pos   = { x = 1035.2606, y = -2490.8467, z = 27.51 },
